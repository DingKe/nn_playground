...
model = Sequential()
# conv1
model.add(TernaryConv2D(128, 3, 3, input_shape=(nb_channel, img_rows, img_cols),
...
# conv2
model.add(TernaryConv2D(128, 3, 3, H=H, W_lr_multiplier=W_lr_multiplier, 
...
# conv3
model.add(TernaryConv2D(256, 3, 3, H=H, W_lr_multiplier=W_lr_multiplier,
...
model.add(Flatten())
# dense1
model.add(TernaryDense(1024, H=H, W_lr_multiplier=W_lr_multiplier, bias=bias, name='dense5'))
model.add(BatchNormalization(epsilon=epsilon, momentum=momentum, name='bn5'))
model.add(Activation(ternary_tanh, name='act5'))
# dense2
model.add(TernaryDense(nb_classes, H=H, W_lr_multiplier=W_lr_multiplier, bias=bias, name='dense6'))
