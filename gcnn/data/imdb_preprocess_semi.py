...
dataset_path = os.path.expandvars('$PWD/aclImdb/')
...
def main():
    ...
    train_x_unsup = grab_data(path+'train/unsup', dictionary)
    ...
    f = open('imdb-full.pkl', 'wb')
    data = {'train_x': train_x, 'train_y': train_y,
            'test_x': test_x, 'test_y': test_y,
            'train_x_unsup': train_x_unsup
            }
    pkl.dump(data, f, True)
    f.close()

    f = open('imdb.dict.pkl', 'wb')
    pkl.dump(dictionary, f, True)
    f.close()
